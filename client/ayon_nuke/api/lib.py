...
def create_write_node(
    ...
    **kwargs
    ...
    # Directory creation is deferred to render time (the write node's
    # "create_directories" knob, set below) rather than made eagerly here, so
    # merely creating a node does not litter empty render folders on disk.
    ...
    with GN:
        ...
        # Create the output directory lazily, at render time, rather than
        # eagerly at node creation. Applies to all write nodes (OVS included).
